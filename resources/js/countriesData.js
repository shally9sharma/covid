...
//Show/Hide the country when change is clicked
chang_country_btn.addEventListener("click", function(){
    input.value="";
    resetCountryList();
    search_country_element.classList.toggle("hide");  /* removes hide from div class list */
    search_country_element.classList.add("fadeIn");   /**animation, slowly it comes */
});

//hide the list when close is clicked
close_list_btn.addEventListener("click", function(){
    search_country_element.classList.toggle("hide");  /* removes hide from div class list */
});

//when you click on one country
country_list_element.addEventListener("click", function(){
    search_country_element.classList.toggle("hide"); 
});

//filter the country based on whatever alphabet entered.
